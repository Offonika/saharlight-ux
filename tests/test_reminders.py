...
from services.api.app.legacy import router as legacy_router
...
def test_real_404(client: TestClient, monkeypatch: pytest.MonkeyPatch) -> None:
    async def fake_list_reminders(_tid: int) -> list[Reminder]:
