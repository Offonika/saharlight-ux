...
from apps.telegram_bot.db import Base
...
async def test_onboarding_demo_photo_missing(monkeypatch, caplog):
    ...
    import apps.telegram_bot.common_handlers  # noqa: F401
    import apps.telegram_bot.onboarding_handlers as onboarding
    import apps.telegram_bot.gpt_client as gpt_client
