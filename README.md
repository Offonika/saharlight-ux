...
Чтобы показать пользователям список команд в интерфейсе Telegram, можно принудительно установить кнопку меню:
...
Результат можно проверить через `getChatMenuButton`.
