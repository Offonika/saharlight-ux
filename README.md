...
### Проверка урока
После загрузки fixtures можно пройти урок целиком в режиме командной строки:

```bash
python scripts/probe_learn.py --lesson xe_basics
```

Скрипт последовательно выполняет шаги и квиз выбранного урока и выводит итоговый балл.
