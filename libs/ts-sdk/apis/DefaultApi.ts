...
export class DefaultApi extends runtime.BaseAPI {
   ...
   * Get Analytics
   */
  async getAnalyticsAnalyticsGetRaw(
    requestParameters: GetAnalyticsAnalyticsGetRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<runtime.ApiResponse<Array<AnalyticsPoint>>> {
    ...
    return new runtime.JSONApiResponse(response, (jsonValue) =>
      jsonValue.map(AnalyticsPointFromJSON),
    );
  }
   ...
   * Get Analytics
   */
  async getAnalyticsAnalyticsGet(
    requestParameters: GetAnalyticsAnalyticsGetRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<Array<AnalyticsPoint>> {
    const response = await this.getAnalyticsAnalyticsGetRaw(
      requestParameters,
      initOverrides,
    );
    return await response.value();
   ...
   * Get Role
   */
  async getRoleUserUserIdRoleGetRaw(
    requestParameters: GetRoleUserUserIdRoleGetRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<runtime.ApiResponse<RoleSchema>> {
   ...
   * Get Role
   */
  async getRoleUserUserIdRoleGet(
    requestParameters: GetRoleUserUserIdRoleGetRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<RoleSchema> {
    const response = await this.getRoleUserUserIdRoleGetRaw(
      requestParameters,
      initOverrides,
    );
    return await response.value();
   ...
   * Get Stats
   */
  async getStatsStatsGetRaw(
    requestParameters: GetStatsStatsGetRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<runtime.ApiResponse<DayStats>> {
    if (requestParameters["telegramId"] == null) {
      throw new runtime.RequiredError(
        "telegramId",
  ...
  async getStatsStatsGet(
    ...
    const response = await this.getStatsStatsGetRaw(
      requestParameters,
      initOverrides,
    );
   ...
   * Get Timezone
   */
  async getTimezoneTimezoneGetRaw(
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<runtime.ApiResponse<{ [key: string]: string }>> {
    const queryParameters: any = {};
   ...
   * Get Timezones
   */
  async getTimezonesTimezonesGetRaw(
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
   ...
   * Get Timezones
   */
  async getTimezonesTimezonesGet(
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
   ...
   * Profile Self
   */
  async profileSelfProfileSelfGetRaw(
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<runtime.ApiResponse<UserContext>> {
    const queryParameters: any = {};
   ...
   * Profile Self
   */
  async profileSelfProfileSelfGet(
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<UserContext> {
   ...
   * Put Role
   */
  async putRoleUserUserIdRolePutRaw(
    requestParameters: PutRoleUserUserIdRolePutRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<runtime.ApiResponse<RoleSchema>> {
    if (requestParameters["userId"] == null) {
      throw new runtime.RequiredError(
   ...
   * Put Role
   */
  async putRoleUserUserIdRolePut(
    requestParameters: PutRoleUserUserIdRolePutRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<RoleSchema> {
    const response = await this.putRoleUserUserIdRolePutRaw(
      requestParameters,
      initOverrides,
    );
    return await response.value();
   ...
   * Put Timezone
   */
  async putTimezoneTimezonePutRaw(
    requestParameters: PutTimezoneTimezonePutRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<runtime.ApiResponse<{ [key: string]: string }>> {
   ...
   * Put Timezone
   */
  async putTimezoneTimezonePut(
    requestParameters: PutTimezoneTimezonePutRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<{ [key: string]: string }> {
    const response = await this.putTimezoneTimezonePutRaw(
      requestParameters,
      initOverrides,
    );
    return await response.value();
