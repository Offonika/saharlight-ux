...
export class OnboardingApi extends runtime.BaseAPI {
   ...
   */
  async onboardingEventsPostRaw(
    requestParameters: OnboardingEventsPostRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<runtime.ApiResponse<ResponseOnboardingEventsPost>> {
    ...
    return new runtime.JSONApiResponse(response, (jsonValue) =>
      ResponseOnboardingEventsPostFromJSON(jsonValue),
    );
  }
   ...
   * Onboarding Events Post
   */
  async onboardingEventsPost(
    requestParameters: OnboardingEventsPostRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<ResponseOnboardingEventsPost> {
    const response = await this.onboardingEventsPostRaw(
      requestParameters,
      initOverrides,
    );
   ...
   */
  async onboardingStatusGetRaw(
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<runtime.ApiResponse<OnboardingStatusResponse>> {
    const queryParameters: any = {};
    ...
    return new runtime.JSONApiResponse(response, (jsonValue) =>
      OnboardingStatusResponseFromJSON(jsonValue),
    );
  }
