...
import type { HTTPValidationError, ReminderSchema } from "../models/index";
import {
...
export class RemindersApi extends runtime.BaseAPI {
   ...
   * Reminders Delete
   */
  async remindersDeleteRaw(
    requestParameters: RemindersDeleteRequest,
  ...
  async remindersDelete(
    ...
    const response = await this.remindersDeleteRaw(
      requestParameters,
      initOverrides,
    );
   ...
   * Reminders Get
   */
  async remindersGetRaw(
    requestParameters: RemindersGetRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<runtime.ApiResponse<Array<ReminderSchema>>> {
    if (requestParameters["telegramId"] == null) {
      throw new runtime.RequiredError(
        "telegramId",
    ...
    return new runtime.JSONApiResponse(response, (jsonValue) =>
      jsonValue.map(ReminderSchemaFromJSON),
    );
  }
  ...
  async remindersGet(
    requestParameters: RemindersGetRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<Array<ReminderSchema>> {
    const response = await this.remindersGetRaw(
      requestParameters,
      initOverrides,
    );
    return await response.value();
   ...
   * Reminders Id Get
   */
  async remindersIdGetRaw(
    requestParameters: RemindersIdGetRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<runtime.ApiResponse<ReminderSchema>> {
    if (requestParameters["id"] == null) {
      throw new runtime.RequiredError(
        "id",
    ...
    return new runtime.JSONApiResponse(response, (jsonValue) =>
      ReminderSchemaFromJSON(jsonValue),
    );
  }
   ...
   * Reminders Id Get
   */
  async remindersIdGet(
    requestParameters: RemindersIdGetRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<ReminderSchema> {
    const response = await this.remindersIdGetRaw(
      requestParameters,
      initOverrides,
    );
    return await response.value();
   ...
   * Reminders Patch
   */
  async remindersPatchRaw(
    requestParameters: RemindersPatchRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<runtime.ApiResponse<{ [key: string]: any }>> {
   ...
   * Reminders Patch
   */
  async remindersPatch(
    requestParameters: RemindersPatchRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<{ [key: string]: any }> {
    const response = await this.remindersPatchRaw(
      requestParameters,
      initOverrides,
    );
    return await response.value();
   ...
   * Reminders Post
   */
  async remindersPostRaw(
    requestParameters: RemindersPostRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<runtime.ApiResponse<{ [key: string]: any }>> {
    if (requestParameters["reminder"] == null) {
      throw new runtime.RequiredError(
  ...
  async remindersPost(
    ...
    const response = await this.remindersPostRaw(
      requestParameters,
      initOverrides,
    );
    return await response.value();
