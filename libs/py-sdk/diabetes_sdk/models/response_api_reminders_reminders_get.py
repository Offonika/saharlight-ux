...
RESPONSEAPIREMINDERSREMINDERSGET_ANY_OF_SCHEMAS = [
    "Dict[str, object]",
...
class ResponseApiRemindersRemindersGet(BaseModel):
    ...
    if TYPE_CHECKING:
        actual_instance: Optional[Union[Dict[str, object], List[Dict[str, object]]]] = (
            None
        )
    else:
    ...
    def actual_instance_must_validate_anyof(cls, v):
        ...
        if error_messages:
            # no match
            raise ValueError(
                "No match found when setting the actual_instance in ResponseApiRemindersRemindersGet with anyOf schemas: Dict[str, object], List[Dict[str, object]]. Details: "
                + ", ".join(error_messages)
            )
        else:
            return v
    ...
    def from_json(cls, json_str: str) -> Self:
        ...
        if error_messages:
            # no match
            raise ValueError(
                "No match found when deserializing the JSON string into ResponseApiRemindersRemindersGet with anyOf schemas: Dict[str, object], List[Dict[str, object]]. Details: "
                + ", ".join(error_messages)
            )
        else:
            return instance
    ...
    def to_dict(
        self,
    ) -> Optional[Union[Dict[str, Any], Dict[str, object], List[Dict[str, object]]]]:
