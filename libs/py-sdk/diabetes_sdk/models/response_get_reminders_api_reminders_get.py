...
RESPONSEGETREMINDERSAPIREMINDERSGET_ANY_OF_SCHEMAS = ["Dict[str, object]", "List[Dict[str, object]]"]

class ResponseGetRemindersApiRemindersGet(BaseModel):
    """
    ...
    def actual_instance_must_validate_anyof(cls, v):
        instance = ResponseGetRemindersApiRemindersGet.model_construct()
        error_messages = []
        ...
        if error_messages:
            # no match
            raise ValueError("No match found when setting the actual_instance in ResponseGetRemindersApiRemindersGet with anyOf schemas: Dict[str, object], List[Dict[str, object]]. Details: " + ", ".join(error_messages))
        else:
            return v
    ...
    def from_json(cls, json_str: str) -> Self:
        ...
        if error_messages:
            # no match
            raise ValueError("No match found when deserializing the JSON string into ResponseGetRemindersApiRemindersGet with anyOf schemas: Dict[str, object], List[Dict[str, object]]. Details: " + ", ".join(error_messages))
        else:
            return instance
