...
class ApiRemindersGet200Response(BaseModel):
    ...
    # data type: List[Reminder]
    oneof_schema_2_validator: Optional[List[Reminder]] = None
    actual_instance: Optional[Union[List[Reminder], Reminder]] = None
    one_of_schemas: Set[str] = { "List[Reminder]", "Reminder" }
    ...
    def actual_instance_must_validate_oneof(cls, v):
        ...
        if not isinstance(v, Reminder):
            error_messages.append(f"Error! Input type `{type(v)}` is not `Reminder`")
        else:
            match += 1
        # validate data type: List[Reminder]
        try:
    ...
    def from_json(cls, json_str: str) -> Self:
        ...
        # deserialize data into Reminder
        try:
            instance.actual_instance = Reminder.from_json(json_str)
            match += 1
        except (ValidationError, ValueError) as e:
            error_messages.append(str(e))
        # deserialize data into List[Reminder]
        try:
            # validation
    ...
    def to_dict(self) -> Optional[Union[Dict[str, Any], List[Reminder], Reminder]]:
