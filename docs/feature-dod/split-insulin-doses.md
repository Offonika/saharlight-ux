...
- [ ] подсказки/ошибки в UI соответствуют разделу [Подписи и подсказки для ввода](../content/style/insulin-doses-copy.md#подписи-и-подсказки-для-ввода);
- [ ] подтверждения сценариев совпадают с [таблицей подтверждений](../content/style/insulin-doses-copy.md#подтверждения-операций).
