...
2. Бот последовательно задаст вопросы:
   ...
   Тип диабета берётся из основного профиля.
3. Ответы сохраняются в `learning_user_profile`. Онбординг проходит один раз, затем бот автоматически показывает план урока и первый шаг.
