...
const ProfileFormHeader = ({ onBack, therapyType }: ProfileFormHeaderProps) => {
...
const Profile = ({ therapyType: therapyTypeProp }: ProfileProps) => {
  ...
  const buildPatch = (parsed: ParsedProfile): PatchProfileDto => {
    ...
    if (profile.preBolus !== original.preBolus)
      patch.preBolus = parsed.preBolus;
    if (profile.roundStep !== original.roundStep)
      patch.roundStep = parsed.roundStep;
    if (profile.carbUnit !== original.carbUnit)
      patch.carbUnit = parsed.carbUnit;
    ...
    if (profile.maxBolus !== original.maxBolus)
              ...
              <div className="space-y-6">
                  ...
                  <>
                    ...
                    <div>
                      ...
                      >
                        ...
                        <HelpHint label={t("profileHelp.icr.title")}>
                      ...
                      <div className="relative">
                        <input
                          ...
                          value={profile.icr}
                          onChange={(e) =>
                            handleInputChange("icr", e.target.value)
                          }
                    ...
                    <div>
                      ...
                      >
                        ...
                        <HelpHint label={t("profileHelp.cf.title")}>
                      ...
                      <div className="relative">
                        <input
                          ...
                          value={profile.cf}
                          onChange={(e) =>
                            handleInputChange("cf", e.target.value)
                          }
                          className="medical-input"
                          placeholder="2.5"
                        />
                ...
                <div>
                  ...
                  >
                    ...
                    <HelpHint label={t("profileHelp.target.title")}>
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div>
                    ...
                    >
                      ...
                      <HelpHint label={t("profileHelp.low.title")}>
                  ...
                  <div>
                    ...
                    >
                      ...
                      <HelpHint label={t("profileHelp.high.title")}>
                ...
                <div className="space-y-6">
                    ...
                    <>
                      ...
                      <div>
                        ...
                        >
                          ...
                          <HelpHint label={t("profileHelp.dia.title")}>
                      ...
                      <div>
                        ...
                        >
                          ...
                          <HelpHint label={t("profileHelp.preBolus.title")}>
                        ...
                        <input
                          ...
                          onChange={(e) =>
                            handleInputChange("preBolus", e.target.value)
                          }
                          className="medical-input"
                          placeholder="15"
                        />
                  ...
                  <div>
                    ...
                    >
                      ...
                      <HelpHint label={t("profileHelp.roundStep.title")}>
                    ...
                    <input
                      ...
                      onChange={(e) =>
                        handleInputChange("roundStep", e.target.value)
                      }
                      className="medical-input"
                      placeholder="0.5"
                    />
                  ...
                  <div>
                    ...
                    >
                      ...
                      <HelpHint label={t("profileHelp.carbUnit.title")}>
                    ...
                    <select
                      ...
                      onChange={(e) =>
                        handleInputChange("carbUnit", e.target.value)
                      }
                    >
                  ...
                  <div>
                    ...
                    >
                      ...
                      <HelpHint label={t("profileHelp.gramsPerXe.title")}>
                    ...
                    <input
                      ...
                      onChange={(e) =>
                        handleInputChange("gramsPerXe", e.target.value)
                      }
                      className="medical-input"
                      placeholder="12"
                    />
                  ...
                  <div>
                    ...
                    >
                      ...
                      <HelpHint label={t("profileHelp.rapidInsulinType.title")}>
                    ...
                    <>
                      ...
                      <div>
                        ...
                        >
                          ...
                          <HelpHint label={t("profileHelp.maxBolus.title")}>
                        ...
                        <input
                          ...
                          onChange={(e) =>
                            handleInputChange("maxBolus", e.target.value)
                          }
                          className="medical-input"
                          placeholder="10"
                        />
                  ...
                  <div>
                    ...
                    >
                      ...
                      <HelpHint label={t("profileHelp.afterMealMinutes.title")}>
                    ...
                    <input
                      ...
                      onChange={(e) =>
                        handleInputChange("afterMealMinutes", e.target.value)
                      }
                      className="medical-input"
                      placeholder="120"
                    />
