...
def upgrade() -> None:
    ...
    op.create_index(op.f('ix_history_records_telegram_id'), 'history_records', ['telegram_id'], unique=False)
    op.alter_column('profiles', 'sos_alerts_enabled',
               existing_type=sa.BOOLEAN(),
               nullable=False)
    ...
    op.alter_column('reminder_logs', 'event_time',
               existing_type=postgresql.TIMESTAMP(timezone=True),
               nullable=False,
               existing_server_default=sa.text('now()'))
    op.alter_column('reminders', 'title',
               ...
               type_=sa.String(),
               nullable=True)
    op.alter_column('reminders', 'is_enabled',
               existing_type=sa.BOOLEAN(),
               nullable=False)
    ...
    op.alter_column('users', 'timezone_auto',
               existing_type=sa.BOOLEAN(),
               server_default=None,
               existing_nullable=False)
